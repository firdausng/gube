export namespace models {
	...
	export class GenerictResult[[]*k8s.io/client-go/tools/clientcmd/api.Context] {
	    ...
	    static createFrom(source: any = {}) {
	        return new GenerictResult[[]*k8s.io/client-go/tools/clientcmd/api.Context](source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.data = this.convertValues(source["data"], api.Context);
	...
	export class GenerictResult[[]k8s.io/api/core/v1.Pod] {
	    ...
	    static createFrom(source: any = {}) {
	        return new GenerictResult[[]k8s.io/api/core/v1.Pod](source);
	    }
